...
function ClassModConfigFunc()
	...
	if IsConfigurableAddOn("BFClassMods") or (IsConfigurableAddOn("AttackTimer") and playerclass == "WARRIOR" or playerclass == "PALADIN" or playerclass == "MONK") or (IsConfigurableAddOn("NewPowerBar") and playerclass == "HUNTER" or playerclass == "WARRIOR" or playerclass == "DRUID" or playerclass == "MONK") or playerclass == "ROGUE" then
