...
A{"AzuremystIsle", 2419, criterion=9121, side="alliance", season="Noblegarden", trivia={criteria="Azure Watch", module="seasonal_noble", category="World Events/Noblegarden", name="Spring Fling", description="Find your pet Spring Rabbit another one to love in each of the towns listed below.", mapID="AzuremystIsle", uiMapID=97, points=10, parent="World Events", type=29}}

-- World Events/Noblegarden: Desert Rose
A{"Badlands", 2436, criterion=9138, season="Noblegarden", trivia={criteria="The Badlands", module="seasonal_noble", category="World Events/Noblegarden", name="Desert Rose", description="Use Spring Robes to plant a flower in each of the deserts listed below.", mapID="Badlands", uiMapID=15, points=10, parent="World Events", type=29}}
A{"Desolace", 2436, criterion=9139, season="Noblegarden", trivia={criteria="Desolace", module="seasonal_noble", category="World Events/Noblegarden", name="Desert Rose", description="Use Spring Robes to plant a flower in each of the deserts listed below.", mapID="Desolace", uiMapID=66, points=10, parent="World Events", type=29}}

-- World Events/Noblegarden: Spring Fling
A{"DunMorogh", 2419, criterion=9201, side="alliance", season="Noblegarden", trivia={criteria="Kharanos", module="seasonal_noble", category="World Events/Noblegarden", name="Spring Fling", description="Find your pet Spring Rabbit another one to love in each of the towns listed below.", mapID="DunMorogh", uiMapID=27, points=10, parent="World Events", type=29}}
A{"Elwynn", 2419, criterion=9200, side="alliance", season="Noblegarden", trivia={criteria="Goldshire", module="seasonal_noble", category="World Events/Noblegarden", name="Spring Fling", description="Find your pet Spring Rabbit another one to love in each of the towns listed below.", mapID="ElwynnForest", uiMapID=37, points=10, parent="World Events", type=29}}

-- World Events/Noblegarden: Desert Rose
A{"Silithus", 2436, criterion=9142, season="Noblegarden", trivia={criteria="Silithus", module="seasonal_noble", category="World Events/Noblegarden", name="Desert Rose", description="Use Spring Robes to plant a flower in each of the deserts listed below.", mapID="Silithus", uiMapID=81, points=10, parent="World Events", type=29}}

-- World Events/Noblegarden: Noble Garden
A{"SilvermoonCity", 2420, side="horde", season="Noblegarden", trivia={module="seasonal_noble", category="World Events/Noblegarden", name="Noble Garden", description="Hide a Brightly Colored Egg in Silvermoon City.", mapID="SilvermoonCity", uiMapID=110, points=10, parent="World Events"}}

-- World Events/Noblegarden: Noble Garden
A{"StormwindCity", 2421, side="alliance", season="Noblegarden", trivia={module="seasonal_noble", category="World Events/Noblegarden", name="Noble Garden", description="Hide a Brightly Colored Egg in Stormwind City.", mapID="StormwindCity", uiMapID=84, points=10, parent="World Events"}}

-- World Events/Noblegarden: Desert Rose
A{"Tanaris", 2436, criterion=9140, season="Noblegarden", trivia={criteria="Tanaris", module="seasonal_noble", category="World Events/Noblegarden", name="Desert Rose", description="Use Spring Robes to plant a flower in each of the deserts listed below.", mapID="Tanaris", uiMapID=71, points=10, parent="World Events", type=29}}

-- World Events/Noblegarden: Spring Fling
A{"Teldrassil", 2419, criterion=9199, side="alliance", season="Noblegarden", trivia={criteria="Dolanaar", module="seasonal_noble", category="World Events/Noblegarden", name="Spring Fling", description="Find your pet Spring Rabbit another one to love in each of the towns listed below.", mapID="Teldrassil", uiMapID=57, points=10, parent="World Events", type=29}}

-- World Events/Noblegarden: Desert Rose
A{"ThousandNeedles", 2436, criterion=9141, season="Noblegarden", trivia={criteria="Thousand Needles", module="seasonal_noble", category="World Events/Noblegarden", name="Desert Rose", description="Use Spring Robes to plant a flower in each of the deserts listed below.", mapID="ThousandNeedles", uiMapID=64, points=10, parent="World Events", type=29}}
