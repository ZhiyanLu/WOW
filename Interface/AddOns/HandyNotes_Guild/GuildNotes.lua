--[[ $Id: GuildNotes.lua 69 2020-10-23 17:08:49Z nevcairiel $ ]]
...
local IsInGuild, GuildRoster = IsInGuild, C_GuildInfo.GuildRoster
...
function GuildHandler:OnEnter(mapFile, coord)
	...
	GameTooltip:AddLine("|cffe0e0e0" .. name .. "|r")
	GameTooltip:AddLine(fmt("L%d - |cff%02x%02x%02x%s|r", playerLevel[name] or 0, player.icon.r * 255, player.icon.g * 255, player.icon.b * 255, playerClassLocalized[name] or UNKNOWN))
	GameTooltip:Show()
end
