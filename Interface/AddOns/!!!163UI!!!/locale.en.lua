...
L["TAG_SPELL"] = "Spell"
L["TAG_DESC_SPELL"] = ""
L["TAG_UNITFRAME"] = "UnitFrame"
L["TAG_DESC_UNITFRAME"] = ""
L["TAG_ACTIONBUTTONCASTBAR"] = "Action&Cast"
L["TAG_DESC_ACTIONBUTTONCASTBAR"] = ""
L["TAG_EQUIPMENT"] = "Equipment"
L["TAG_DESC_EQUIPMENT"] = ""
L["TAG_COLLECT"] = "Achievement"
L["TAG_DESC_COLLECT"] = ""
...
--[[ 164]] L["网易有爱插件集"] = "NetEaseUI Bundle"
...
--[[ 581]] L["有爱设置"] = "Settings"
--[[ 597]] --L["有爱设置"] = true
--[[ 597]] L["直接显示网易有爱的介绍和配置项，再次点击则恢复当前的选择插件"] = "Jump to NetEaseUI's option page. Click the button again to go back to the former selected addon."
...
--[[ 650]] --L["方案管理"] = true
--[[ 650]] L["方案"] = "Prf"
--[[ 666]] L["网易有爱快捷设置"] = "NetEaseUI Quick Menu"
...
--[[1745]] L["网易有爱"] = "NetEaseUI"
--[[1745]] L["点击有爱标志开启插件控制中心\n \nCtrl点击小地图图标可以收集/还原"] = "Click the icon to open NetEaseUI control panel.\n \nCtrl click minimap buttons to gather/restore them."
--[[1754]] --L["网易有爱"] = true
--[[1771]] L["网易有爱插件中心"] = "NeteaseUI Control Panel"
--[[1773]] L["    网易有爱（163UI）是网易大神隆重推出的新一代整合插件。其设计理念是兼顾整合插件的易用性和单体插件的灵活性，同时适合普通和高级用户群体。|n|n    功能上，网易有爱实现了任意插件的随需加载，并可先进入游戏再逐一加载插件，此为全球首创。此外还有标签分类、拼音检索、界面缩排等特色功能。"] = "An advanced in-game addon control center, which combines Categoring, Searching, Loading and Setting of wow addons all together."
...
L["SAVE CURRENT PROFILE AS ACCOUNT GLOBAL PROFILE?"] = true
L["USE GLOBAL PROFILE OR CHARACTER'S OLD PROFILE?"] = true
L["GLOBAL PROFILE"] = true
L["CHARACTER PROFILE"] = true
L["NetEaseUI Profiles"] = true
L["Saved"] = true
L["Auto"] = true
...
L["Simple Style"] = true
L["Do you want to use Simple UI?"] = true
L["Global Setting Tip"] = "Left click to toggle account global setting\nRight click to toggle current character"
L["Global Setting Character"] = "Current Char"
L["Reload to apply addon account global setting?"] = true
L["Profile: "] = true
L["AddOns: "] = true
L["Today"] = true
L["AddOn States"] = true
...
--[[  32]] L["|cffcd1a1c【网易有爱】|r- "] = "|cffcd1a1cNetEaseUI|r - "
