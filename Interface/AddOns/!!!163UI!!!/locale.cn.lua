...
L["SAVE CURRENT PROFILE AS ACCOUNT GLOBAL PROFILE?"] = "是否将当前角色的设置文件覆盖到帐号通用设置？\n\124cff00ff00`确定`后，帐号的设置将被该角色的设置覆盖\124r"
L["USE GLOBAL PROFILE OR CHARACTER'S OLD PROFILE?"] = "使用帐号通用设置还是恢复到角色本来的旧设置?该角色将不再使用帐号通用设置\n选`\124cff00ff00账号设置\124r`后，复制一份帐号通用设置作为角色设置。\n选`\124cff00ffff角色设置\124r`后，该角色将恢复到开启账号通用设置功能之前的配置"
L["GLOBAL PROFILE"] = "\124cff00ff00账号设置\124r"
L["CHARACTER PROFILE"] = "\124cff00ffff角色设置\124r"
