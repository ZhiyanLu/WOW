...
local pairs,ipairs,next,wipe,assert,type,tinsert,select,tremove,GetTime,setmetatable,rawget = pairs,ipairs,next,wipe,assert,type,tinsert,select,tremove,GetTime,setmetatable, rawget
            ...
            if proxyFrame and not dropDownList1:IsVisible() and not isv("UIDROPDOWNMENU_MENU_LEVEL") then --这里一旦去掉 isv("UIDROPDOWNMENU_MENU_LEVEL") 这个条件, 立刻污染groupMode
                ...
                if dropDownList1.numButtons then --and not isv(dropDownList1, "numButtons") then
                    ...
                    for j=1, dropDownList1.numButtons, 1 do
                        local button = _G["DropDownList1Button"..j];
                        button:Hide();
                    end
                    --如果在加载期间设置，会导致污染
...
function InterfaceOptions_AddCategory (frame, addOn, position)
    ...
    frame.name = frame.name:gsub("%|cff880303%[网易有爱%]%|r ", ""):gsub("%|cff880303%[有爱%]%|r ", "")
    frame.parent = frame.parent and frame.parent:gsub("%|cff880303%[网易有爱%]%|r ", ""):gsub("%|cff880303%[有爱%]%|r ", "")
...
U1STAFF = {
    ["Player-962-0509AC92"] = "WARRIOR",
    ["Player-962-04FEC839"] = "MAGE",
    ["Player-962-0509E004"] = "PALADIN",
    ["Player-962-0509E001"] = "DRUID",
    ["Player-962-0509E049"] = "PRIEST",
    --
    ["Player-962-0509ACEF"] = "MAGE",
    ["Player-962-0508A77F"] = "DRUID",
    ["Player-962-0508A6CC"] = "SHAMAN",
    ["Player-962-0508ADA1"] = "HUNTER",
    ["Player-962-0508AD8B"] = "WARRIOR",
    ["Player-962-0508ADDC"] = "PRIEST",
    ["Player-962-0508AD43"] = "PALADIN",
    ["Player-962-0508AD11"] = "ROGUE",
    ["Player-962-04FF445B"] = "PALADIN-MINUS",
    ["Player-962-0509EA70"] = "PRIEST-MINUS",
};
...
SlashCmdList["PRINT"]=function(msg)
    local func = loadstring("return " .. msg);
    if func then
        print(func());
    else
        print("error excuting", msg);
    end
end
