...
do 
	...
	----调试开关
	UNIT_INVENTORY_CHANGED_Debug1 = true;
	...
	local function CheckFrame(frame)
		if not frame:IsForbidden() then
			if frame:IsEventRegistered("UNIT_INVENTORY_CHANGED") then
				return true
			end
		end
	end
