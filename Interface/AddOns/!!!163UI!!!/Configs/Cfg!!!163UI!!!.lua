...
U1RegisterAddon("!!!163UI!!!", {
    ...
    },
    {
        ...
        --     callback = function(cfg, v, loading)
        --         U1DBA.configs["!!!163ui!!!/displayLinkageStatusAsBuff"] = false
    ...
    },
    {
        ...
        default = 1,
        getvalue = function() return not U1DBA.disableLaterLoading end,
        callback = function(cfg, v, loading)
            U1DBA.disableLaterLoading = not v;
        end,
        {
            var = "speed",
            text = L["插件加载速度（个/秒）"],
            ...
            type = "spin",
            range = {1, 10, 1},
            getvalue = function() return U1DBA.loadSpeed end,
            callback = function(cfg, v, loading)
                U1DBA.loadSpeed = v
            end,
        }
    ...
    },
    {
        ...
        },
        {
            ...
            getvalue = function() return not U1DBA.sortByName end,
            callback = function(cfg, v, loading)
                U1DBA.sortByName = not v;
                if not loading then
