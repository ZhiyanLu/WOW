...
U1RegisterAddon("LiteBuff", {
    title = "职业快捷按钮",
    defaultEnable = 1,
    tags = { "TAG_COMBATINFO", "TAG_CLASS", "TAG_WARRIOR", "TAG_PALADIN", "TAG_ROGUE", "TAG_DEATHKNIGHT", "TAG_DRUID", "TAG_SHAMAN", "TAG_MONK", "TAG_DEMONHUNTER", "TAG_HUNTER", "TAG_MAGE", "TAG_WARLOCK", "TAG_PRIEST", },
