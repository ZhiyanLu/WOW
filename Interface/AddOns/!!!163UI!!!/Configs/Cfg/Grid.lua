...
U1RegisterAddon("GridStatusRD_BfA", {title = "争霸艾泽拉斯", protected = nil, hide = nil, load="NORMAL", parent="GridStatusRaidDebuff", });
U1RegisterAddon("GridStatusRD_Legion", {title = "军团再临", protected = nil, hide = nil, load="NORMAL", parent="GridStatusRaidDebuff", });
U1RegisterAddon("GridStatusRD_WoD", {title = "德拉诺之王", protected = nil, hide = nil, load="NORMAL", parent="GridStatusRaidDebuff", });
U1RegisterAddon("GridStatusRD_MoP", {title = "熊猫人之谜", protected = nil, hide = nil, load="NORMAL", parent="GridStatusRaidDebuff", });
