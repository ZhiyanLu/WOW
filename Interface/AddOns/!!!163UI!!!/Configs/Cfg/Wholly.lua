U1RegisterAddon("Wholly", { 
    ...
    runBeforeLoad = function() EnableAddOn("Grail-Quests-_retail_-zhCN") end,
...
U1RegisterAddon("Grail-NPCs-_retail_-zhCN", { title = "NPC名称本地化-简中", load = "DEMAND", defaultEnable = 1, })
U1RegisterAddon("Grail-Quests-_retail_-zhCN", { title = "任务名称本地化-简中", load = "DEMAND", defaultEnable = 1, })
U1RegisterAddon("Grail-NPCs-_retail_-zhTW", { title = "NPC名称本地化-繁中", load = "DEMAND", defaultEnable = 1, })
U1RegisterAddon("Grail-Quests-_retail_-zhTW", { title = "任务名称本地化-繁中", load = "DEMAND", defaultEnable = 1, })
U1RegisterAddon("Grail-NPCs-_retail_-enUS", { title = "NPC名称本地化-英文", load = "DEMAND", defaultEnable = 1, })
U1RegisterAddon("Grail-Quests-_retail_-enUS", { title = "任务名称本地化-英文", load = "DEMAND", defaultEnable = 1, })
