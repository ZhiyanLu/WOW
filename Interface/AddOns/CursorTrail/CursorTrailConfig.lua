...
function OptionsFrame_Create()
    ...
    OptionsFrame.DefaultsBtn1 = CreateFrame("Button", nil, OptionsFrame, "OptionsButtonTemplate")
    ...
    -- DEFAULT BUTTON 2 --
    OptionsFrame.DefaultsBtn2 = CreateFrame("Button", nil, OptionsFrame, "OptionsButtonTemplate")
    ...
    -- DEFAULT BUTTON 3 --
    OptionsFrame.DefaultsBtn3 = CreateFrame("Button", nil, OptionsFrame, "OptionsButtonTemplate")
    ...
    -- DEFAULT BUTTON 4 --
    OptionsFrame.DefaultsBtn4 = CreateFrame("Button", nil, OptionsFrame, "OptionsButtonTemplate")
    ...
    -- DEFAULT BUTTON 5 --
    OptionsFrame.DefaultsBtn5 = CreateFrame("Button", nil, OptionsFrame, "OptionsButtonTemplate")
    ...
    -- DEFAULT BUTTON 6 --
    OptionsFrame.DefaultsBtn6 = CreateFrame("Button", nil, OptionsFrame, "OptionsButtonTemplate")
    ...
    -- DEFAULT BUTTON 7 --
    OptionsFrame.DefaultsBtn7 = CreateFrame("Button", nil, OptionsFrame, "OptionsButtonTemplate")
    ...
    -- DEFAULT BUTTON 8 --
    OptionsFrame.DefaultsBtn8 = CreateFrame("Button", nil, OptionsFrame, "OptionsButtonTemplate")
    ...
    -- DEFAULT BUTTON 9 --
    OptionsFrame.DefaultsBtn9 = CreateFrame("Button", nil, OptionsFrame, "OptionsButtonTemplate")
    ...
    -- DEFAULT BUTTON 10 --
    OptionsFrame.DefaultsBtn10 = CreateFrame("Button", nil, OptionsFrame, "OptionsButtonTemplate")
    ...
    -- CANCEL BUTTON --
    OptionsFrame.CancelBtn = CreateFrame("Button", nil, OptionsFrame, "OptionsButtonTemplate")
    ...
    -- OKAY BUTTON --
    OptionsFrame.OkayBtn = CreateFrame("Button", nil, OptionsFrame, "OptionsButtonTemplate")
...
function OptionsFrame_CreateModelDropDown(x, y, width)
    ...
    -- Add the items.
    if (kGameTocVersion >= 80200) then
        ----local sortedChoices = CopyTable(kModelConstants)
        ----table.sort(sortedChoices, function(data1, data2) return (data1.Name < data2.Name); end)
        ----for modelID, modelData in pairs(sortedChoices) do
    ...
    else  -- 80100 and older
        dropdown:AddItem(PlayerConfig.ModelID, PlayerConfig.ModelID)
    end
