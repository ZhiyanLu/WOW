...
L["CONFIG_SELLING_TBC_SHOW_ALL_RESULTS"] = "包括不需要在结果中获得最低价格的拍卖"
L["CONFIG_SELLING_TBC_SHOW_ALL_RESULTS_TOOLTIP_HEADER"] = "显示所有 结果"
L["CONFIG_SELLING_TBC_SHOW_ALL_RESULTS_TOOLTIP_TEXT"] = "启用此设置会导致搜索结果的所有页面并列出所有找到的拍卖，即使只需要第一页来确定最低价格。"
...
L["SPLASH_9105_DESCRIPTION"] = "添加了一种新的购物清单搜索方法，可以在14秒内扫描和过滤数千件商品的价格（在全负载的大服大约为42秒）--以前这可能需要20分钟！当与金币价格过滤器结合使用时，这对于阻击完美交易非常宝贵。"
L["SPLASH_9105_FEATURES_1"] = "搜索超过50件商品时，购物清单搜索速度非常快"
...
L["SPLASH_9108_FEATURES_9"] = "可以取消自己的拍卖，无论实在购买界面内还是在带有压价扫描的专用标签上。"
