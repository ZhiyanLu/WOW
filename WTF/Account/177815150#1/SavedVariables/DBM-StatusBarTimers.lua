...
DBT_AllPersistentOptions = {
	["Default"] = {
		["DBM"] = {
			...
			["EnlargeBarsPercent"] = 0.4,
			["HugeBarYOffset"] = 0,
			["EndColorPR"] = 0.168627450980392,
			["Sort"] = true,
			["ExpandUpwards"] = false,
			["TimerPoint"] = "CENTER",
			["EndColorDG"] = 0,
			...
			["TextColorB"] = 1,
			["Flash"] = true,
			["HugeTimerX"] = -19.2410411834717,
			["TimerY"] = -69.7548522949219,
			["EndColorRB"] = 0.301960784313726,
			["TimerX"] = -311.343414306641,
			...
			["HugeTimerY"] = -93.2296142578125,
			["ClickThrough"] = false,
			["ColorByType"] = true,
			["IconLeft"] = true,
			["Width"] = 200,
			["Template"] = "DBTBarTemplate",
			["EndColorG"] = 0.811764705882353,
			["StartColorAB"] = 1,
			["EndColorUIG"] = 0.92156862745098,
			["Bar7CustomInline"] = true,
			["EndColorDB"] = 1,
			["EndColorPB"] = 0.258823529411765,
