		...
		["Default"] = {
			...
			["positions"] = {
				...
				["boss"] = {
					...
					["x"] = 1152.959931278229,
					["point"] = "TOPRIGHT",
					["bottom"] = 276.9778643502068,
					["relativePoint"] = "BOTTOMLEFT",
					["top"] = 568.9777981175284,
				},
				["battleground"] = {
					["anchorPoint"] = "C",
				},
			...
			["filters"] = {
				...
				["zoneblack"] = {
					["arenafocustarget"] = "没用的buff",
					["pvptargettarget"] = "没用的buff",
					["arenafocus"] = "没用的buff",
					["nonefocus"] = "没用的buff",
					["partyfocustarget"] = "没用的buff",
					["arenaboss"] = "不显示",
					["pvpfocustarget"] = "没用的buff",
					["nonetargettarget"] = "没用的buff",
					["raidtargettarget"] = "没用的buff",
					["nonefocustarget"] = "没用的buff",
					["noneboss"] = "不显示",
					["pvpfocus"] = "没用的buff",
					["raidfocus"] = "没用的buff",
					["partytargettarget"] = "没用的buff",
					["arenatargettarget"] = "没用的buff",
					["partyboss"] = "不显示",
					["raidboss"] = "不显示",
					["partyfocus"] = "没用的buff",
					["pvpboss"] = "不显示",
					["raidfocustarget"] = "没用的buff",
				},
			},
			["revision"] = 62,
			["castColors"] = {
